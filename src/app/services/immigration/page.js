...
export default function Page() {
  ...
  const handleCountryChange = (e) => {
    ...
    if (isMounted && country) {
      ...
      router.push(`/services/immigration/${country}`);
    }
  };
    ...
    <div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Get started with registering your immigration in your selected
            country.
          </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <p className="text-center text-gray-600">
          Once you select a country, you&apos;ll be redirected to its dedicated
          page with information and resources for business registration.
        </p>
      </div>
    </div>
  );
